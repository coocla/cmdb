...
class Event(object):
    ...
    def __init__(self, event_id=None, event_uuid=None,
            event_type="default", event_method="REQUEST", event_data=None,
    ...
    def setEventRemoteIP(self, event_remoteip):
        self.RemoteIP = event_remoteip
    ...
    def fromJSON(event_json):
        ...
        event_data = json.loads(base64.decodestring(event_dict["event_data"]))
        ...
        return Event(event_id=event_id, event_uuid=event_uuid, event_type=event_type,
                ...
                event_channel=event_channel, rabbitmq_vhost=rabbitmq_vhost, 
                rabbitmq_exchange=rabbitmq_exchange, event_environ=event_environ, step_id=step_id,
                event_timeout=event_timeout, event_args=event_args, flow_uuid=flow_uuid, 
